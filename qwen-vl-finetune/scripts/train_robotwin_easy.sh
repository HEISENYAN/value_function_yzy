...
datasets="/project/peilab/junhao/.cache/huggingface/lerobot/robotwin_aloha_lerobot/beat_block_hammer_clean_50"
...
run_name="robotwin_easy_1"
output_dir=./output/robotwin_easy_1
