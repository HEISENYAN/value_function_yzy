...
export XDG_CACHE_HOME=${XDG_CACHE_HOME:-/tmp/${USER:-lijunhao}/.cache}
...
entry_file=qwenvl/train/train_qwen_pair_map.py

run_name="robotwin50_pair_map"

llm=/mnt/lijunhao/output/value_function/checkpoints/Qwen2.5-VL-3B-Instruct
# datasets="/mnt/lijunhao/dataset/robotwin/adjust_bottle/aloha-agilex_clean_50"
