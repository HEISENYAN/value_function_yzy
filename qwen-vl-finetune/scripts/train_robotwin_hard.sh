...
datasets="/project/peilab/junhao/.cache/huggingface/lerobot/robotwin_aloha_lerobot/beat_block_hammer_randomized_500"
...
run_name="robotwin_hard_1"
output_dir=./output/robotwin_hard_1
